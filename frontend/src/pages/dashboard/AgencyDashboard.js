...
const AgencyDashboard = () => {
  ...
  // Per-role nav arrays (defined inside component so badge: unreadCount is live)
      ...
      <DashboardLayout
        ...
        <Routes>
          ...
          {agencyRole === "director" && <>
            ...
            <Route path="demandes"  element={<DemandesPage senderType="Agency" />} />
          ...
          {/* ── Shared routes — available to every role ── */}
